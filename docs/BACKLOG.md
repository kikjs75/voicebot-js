...
- [작성 규칙](#작성-규칙)
- [목록](#목록)
  - [\[검증\] 직접 테스트 및 소스 분석](#검증-직접-테스트-및-소스-분석)
  - [\[개선\] TTS 음성 브라우저 재생](#개선-tts-음성-브라우저-재생)
  - [\[개선\] LLM 응답시간 단축](#개선-llm-응답시간-단축)
  - [\[개선\] TTS 응답시간 단축](#개선-tts-응답시간-단축)
  - [\[개선\] 전체 파이프라인 응답시간 5,000ms 이내](#개선-전체-파이프라인-응답시간-5000ms-이내)
  - [\[개선\] 콜센터 시나리오 시스템 프롬프트 커스터마이징](#개선-콜센터-시나리오-시스템-프롬프트-커스터마이징)
  - [\[개선\] 연속 발화 지원](#개선-연속-발화-지원)
  - [\[개선\] Spring Boot 재시작 없이 .env 환경변수 로드](#개선-spring-boot-재시작-없이-env-환경변수-로드)
