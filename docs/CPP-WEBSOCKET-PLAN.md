...
- [목적](#목적)
- [전체 구조 비교](#전체-구조-비교)
- [브라우저 전환 방법](#브라우저-전환-방법)
- [변경 범위](#변경-범위)
- [서비스 인터페이스 설계 — Java 대응 C++ 구조](#서비스-인터페이스-설계--java-대응-c-구조)
- [프로젝트 디렉토리 구조 (안)](#프로젝트-디렉토리-구조-안)
- [브라우저 ↔ C++ 메시지 프로토콜](#브라우저--c-메시지-프로토콜)
- [검토 항목 결정 내용](#검토-항목-결정-내용)
- [코드 리뷰 및 수정 이력 (2026-06-04)](#코드-리뷰-및-수정-이력-2026-06-04)
