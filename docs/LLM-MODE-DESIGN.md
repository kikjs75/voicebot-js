...
- [개요](#개요)
- [배경 및 목적](#배경-및-목적)
- [3가지 LLM 모드](#3가지-llm-모드)
- [설정 파일](#설정-파일)
- [MongoDB Playbook 구조](#mongodb-playbook-구조)
- [Claude API 의도 분류 프롬프트](#claude-api-의도-분류-프롬프트)
- [소스 구조](#소스-구조)
- [인프라 변경](#인프라-변경)
- [성능 로그 (기존 패턴 유지)](#성능-로그-기존-패턴-유지)
- [구현 순서 (검토 후 진행)](#구현-순서-검토-후-진행)
- [구현 후 수정이 필요한 가이드 문서](#구현-후-수정이-필요한-가이드-문서)
- [구현 결과 요약](#구현-결과-요약)
- [질문](#질문)
